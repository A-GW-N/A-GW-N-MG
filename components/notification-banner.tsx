  ...
  return (
    <div className={cn(
      ...
      <div className="mx-auto flex max-w-[1600px] items-start gap-3 md:items-center">
        ...
        <div className="flex-1 [&_a]:font-medium [&_a]:underline [&_a]:underline-offset-2 [&_a]:text-inherit [&_p]:leading-relaxed [&_p]:text-inherit [&_strong]:text-inherit [&_li]:text-inherit">
